...
## Patch information
Three patch files are provided for the *spacedem* ROM set as found in MAME. It has been tested for this ROM set only and may not work on other revisions of Space Demon if there are other undumped revisions of the game.

| **Patched ROM Name** | **Size** | **CRC-32 Checksum** | **IC Location** |
|----------------------|----------|---------------------|-----------------|
| sdm-c-5e             |    2k    |       2BF8F736      |        5E       |
| sdm-c-5f             |    2k    |       0E1D518A      |        5F       |
| sdm-c-5n             |    2k    |       548C67E7      |        5N       |
