...
----------------------------------
0x4D27   Call 5FD0       CD D0 5F     //Check to see if the free play dip switches are enabled

0x5FD0   ld a, ($7F80)   3A 80 7F     //Read the dip switches
0x5FD3   and $0C         E6 0C        //Compare only switches C and D
0x5FD5   cp $0C          FE 0C        //Check to make sure both switches are flipped
0x5FD7   ld a, $01       3E 01        //Load the write value
0x5FD9   jr z, $5FDA     28 01        //If it isn't the right settings, clear a (fp not set)
0x5FDB   xor a           97           //Make the value 0
0x5FDC   ld ($6BF0), a   32 F0 6B     //Write the free play status
0x5FDF   ret                          //Returns with FP status in register a
```
